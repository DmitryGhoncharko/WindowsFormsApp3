...
public class ProductDao
{
    ...
    public void AddProduct(Product product)
    {
        ...
        connection.Open();
        var sql =
            "INSERT INTO Products (name, category, quantity, min_quantity) VALUES (@Name, @Category, @Quantity, @MinQuantity)";
        using var command = new MySqlCommand(sql, connection);
    ...
    public void UpdateProduct(Product product)
    {
        ...
        connection.Open();
        var sql =
            "UPDATE Products SET name = @Name, category = @Category, quantity = @Quantity, min_quantity = @MinQuantity WHERE product_id = @ProductId";
        using var command = new MySqlCommand(sql, connection);
        command.Parameters.AddWithValue("@Name", product.Name);
        command.Parameters.AddWithValue("@Category", product.Category);
        command.Parameters.AddWithValue("@Quantity", product.Quantity);
